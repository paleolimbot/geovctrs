...
static SEXP _geovctrs_geovctrs_cpp_zlim_try(SEXP dataSEXP, SEXP naRmSEXP, SEXP onlyFiniteSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::traits::input_parameter< SEXP >::type data(dataSEXP);
    Rcpp::traits::input_parameter< bool >::type naRm(naRmSEXP);
    Rcpp::traits::input_parameter< bool >::type onlyFinite(onlyFiniteSEXP);
    rcpp_result_gen = Rcpp::wrap(geovctrs_cpp_zlim(data, naRm, onlyFinite));
    return rcpp_result_gen;
END_RCPP_RETURN_ERROR
}
RcppExport SEXP _geovctrs_geovctrs_cpp_zlim(SEXP dataSEXP, SEXP naRmSEXP, SEXP onlyFiniteSEXP) {
    SEXP rcpp_result_gen;
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(_geovctrs_geovctrs_cpp_zlim_try(dataSEXP, naRmSEXP, onlyFiniteSEXP));
    }
    Rboolean rcpp_isInterrupt_gen = Rf_inherits(rcpp_result_gen, "interrupted-error");
    if (rcpp_isInterrupt_gen) {
        UNPROTECT(1);
...
static int _geovctrs_RcppExport_validate(const char* sig) { 
    ...
    if (signatures.empty()) {
        ...
        signatures.insert("SEXP(*geovctrs_cpp_zlim)(SEXP,bool,bool)");
...
RcppExport SEXP _geovctrs_RcppExport_registerCCallable() { 
    ...
    R_RegisterCCallable("geovctrs", "_geovctrs_geovctrs_cpp_zlim", (DL_FUNC)_geovctrs_geovctrs_cpp_zlim_try);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_geovctrs_geovctrs_cpp_zlim", (DL_FUNC) &_geovctrs_geovctrs_cpp_zlim, 3},
